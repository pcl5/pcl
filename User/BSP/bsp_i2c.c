 ...
 * @Version: 1.0
 * @Autor: PCL
 * @Date: 2023-07-31 10:56:46
 * @Code Reference: cbr wgj wx
 * @LastEditTime: 2023-07-31 11:20:45
 */
/**
 * @file tv_i2c.c
...
// extern tI2CMInstance I2C8Inst;//删掉了volatile
// extern tI2CMInstance I2C2Inst;//删掉了volatile
// extern volatile bool I2C8Done;
// extern volatile bool I2C2Done;
// extern tI2CMWrite8 I2C8WriteInst;//删掉了volatile
// extern tI2CMWrite8 I2C2WriteInst;//删掉了volatile


tI2CMInstance I2C8Inst={0};
tI2CMInstance I2C2Inst={0};
volatile bool I2C8Done = true;
volatile bool I2C2Done = true;
tI2CMWrite8 I2C8WriteInst={0};
tI2CMWrite8 I2C2WriteInst={0};
...
void I2C8_Write(uint8_t DevAddress, uint8_t DevReg, uint8_t *pData, uint8_t Length)
{
    ...
    if(DataBuf==NULL)
    {
        USB_Printf("I2C8_Write: malloc failed\r\n");
        return;
    }
    DataBuf[0]=DevReg;
...
void I2C2_Write(uint8_t DevAddress, uint8_t DevReg, uint8_t *pData, uint8_t Length)
{
    ...
    if(DataBuf==NULL)
    {
        USB_Printf("I2C2_Write: malloc failed\r\n");
        return;
    }
    DataBuf[0]=DevReg;
    memcpy(DataBuf+1, pData, Length);
